  ...
  <tr>
    <td align="center">
      <table>
        ...
        <tr>
          <td align="center">x > 2.5 i.e 2.7</td>
          <td align="center">x < 2.5 i.e 2.3</td>
        </tr>
      </table>
    </td>
    <td align="center"></td>
...
|------|------|-------|--------|--------|---------|-------|
| 0    | 2.300| -0.210| -0.400 | 0.044  | 0.168   | 2.298 |
| 1    | 2.298| -0.206| -0.404 | 0.042  | 0.166   | 2.297 |
| 2    | 2.297| -0.202| -0.408 | 0.041  | 0.165   | 2.295 |
| 3    | 2.295| -0.198| -0.412 | 0.039  | 0.163   | 2.293 |
| 4    | 2.293| -0.194| -0.416 | 0.038  | 0.161   | 2.292 |
| 5    | 2.292| -0.190| -0.420 | 0.036  | 0.160   | 2.290 |
| 10   | 2.280| -0.154| -0.440 | 0.024  | 0.135   | 2.279 |
| 15   | 2.250| -0.088| -0.500 | 0.008  | 0.088   | 2.249 |
| 20   | 2.200| 0.000 | -0.600 | 0.000  | 0.000   | 2.200 |
| 25   | 2.150| 0.098 | -0.700 | 0.010  | -0.137  | 2.151 |
| 30   | 2.100| 0.210 | -0.800 | 0.044  | -0.336  | 2.103 |
...
| Iter | xₙ   | f(xₙ) | f'(xₙ) | f(xₙ)² | g'(xₙ) | xₙ₊₁  |
|------|------|-------|--------|--------|---------|-------|
| 0    | 2.700| -0.210| 0.400  | 0.044  | -0.168  | 2.702 |
| 1    | 2.702| -0.206| 0.404  | 0.042  | -0.166  | 2.703 |
| 2    | 2.703| -0.202| 0.408  | 0.041  | -0.165  | 2.705 |
| 3    | 2.705| -0.198| 0.412  | 0.039  | -0.163  | 2.707 |
| 4    | 2.707| -0.194| 0.416  | 0.038  | -0.161  | 2.708 |
| 5    | 2.708| -0.190| 0.420  | 0.036  | -0.160  | 2.710 |
| 10   | 2.720| -0.154| 0.440  | 0.024  | -0.135  | 2.721 |
| 15   | 2.750| -0.088| 0.500  | 0.008  | -0.088  | 2.751 |
| 20   | 2.800| 0.000 | 0.600  | 0.000  | 0.000   | 2.800 |
| 25   | 2.850| 0.098 | 0.700  | 0.010  | 0.137   | 2.849 |
...
- Starting from x = 2.3 → converges toward root at x = 2.0
- Starting from x = 2.7 → converges toward root at x = 3.0
